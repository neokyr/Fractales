    ...
    if (argc == 4) {
        ...
        if (h <= mode.h && w <= mode.w) {
            ...
            if (strcmp(argv[3], "Mandelbrot") == 0 || strcmp(argv[3], "Julia") == 0) {
                SDL_Window *window = SDL_CreateWindow("MANNY!", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, h, w,
                                                      0);
                if (!window) {
                ...
                t_colors colors;
                Uint32 palette[6] = { 0x00FC9E00, 0x43DE0400, 0xF5DD1100, 0xDE860400, 0xFF280000, 0x00000000 };
